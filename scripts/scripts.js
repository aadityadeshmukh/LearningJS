...
let orderedList = inventors.sort(function(localFirst, localSecond) {
  if (localFirst.year > localSecond.year) return 1;
  else return -1;
});
...
// let links = Array.from(category.querySelector('a'));
// const de = links.map(link => link.textContent)
//                 .filter(streetName => streetName.includes('de'));
// 7. sort Exercise
// Sort the people alphabetically by last name

let alpha = people.sort(function(a, b) {
